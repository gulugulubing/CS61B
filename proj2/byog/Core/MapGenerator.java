...
public class MapGenerator {
    ...
    protected static ArrayList<Rectangle> hallway = new ArrayList<>();
    ...
    protected void completeHallway(TETile[][] world, ArrayList<Rectangle> hallway) {
        Rectangle tempHallway;
        for (int i = 0; i < hallway.size(); i++) {
            tempHallway = hallway.get(i);
    ...
    protected void playerMove(TETile[][] world, TERenderer ter) {
        int xLocation;
        int yLocation;
    ...
    public static void main(String[] args) {
        ...
        MapGenerator mp = new MapGenerator(2873123);
        mp.start(finalWorldFrame);
        mp.completeHallway(finalWorldFrame, hallway);
        ter.renderFrame(finalWorldFrame);
        mp.playerMove(finalWorldFrame,ter);
    }
