...
public class GuitarString {
    ...
    public void tic() {
        ...
        double combine = (DECAY * (first + next) / 2);
        buffer.enqueue(combine);
    }
    ...
    public double sample() {
        try {
            return buffer.peek();
        } catch (RuntimeException e) {// catch the throw, thus code will not stop when running.
            System.out.println("try to sample the empty");
        }
        return 0.0;
    }
}
